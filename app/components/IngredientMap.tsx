...
const farms: Farm[] = [
  {
    ...
    distance: 12,
    description:
      "Family-owned organic farm focused on sustainable growing practices and regenerative agriculture.",
  ...
  },
  {
    ...
    distance: 8,
    description:
      "Specializing in heirloom varieties and rare herbs using natural growing methods.",
  ...
  },
  {
    ...
    distance: 15,
    description:
      "Animal welfare certified dairy producing small-batch artisanal cheeses and dairy products.",
  ...
  },
  {
    ...
    distance: 18,
    description:
      "Multi-generational orchard using integrated pest management and pollinator-friendly practices.",
  ...
  },
  {
    ...
    distance: 5,
    description:
      "Urban vertical farm growing nutrient-dense microgreens using 95% less water than conventional farming.",
...
const ingredients: Ingredient[] = [
  {
    ...
    farmId: 1,
    image:
      "https://images.unsplash.com/photo-1582284540246-9726ba4a4a56?w=250&h=250&fit=crop",
    fallbackImage:
      "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=250&h=250&fit=crop",
    description:
      "Organically grown, vine-ripened heirloom tomatoes with rich flavor profiles.",
  ...
  },
  {
    ...
    farmId: 1,
    image:
      "https://images.unsplash.com/photo-1515686413624-53f6f5aefb38?w=250&h=250&fit=crop",
    fallbackImage:
      "https://images.unsplash.com/photo-1631954732421-ab3c97290342?w=250&h=250&fit=crop",
    description:
      "Tender young kale leaves harvested for optimal nutrition and mild flavor.",
  ...
  },
  {
    ...
    farmId: 2,
    image:
      "https://images.unsplash.com/photo-1504674641010-472d2f845079?w=250&h=250&fit=crop",
    fallbackImage:
      "https://images.unsplash.com/photo-1543242594-c8bae8b9e708?w=250&h=250&fit=crop",
    description:
      "Forest-grown shiitake mushrooms cultivated on fallen oak logs.",
  ...
  },
  {
    ...
    farmId: 3,
    image:
      "https://images.unsplash.com/photo-1552767080-9f3bf8123af2?w=250&h=250&fit=crop",
    fallbackImage:
      "https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=250&h=250&fit=crop",
    description:
      "Small-batch goat cheese made from the milk of pasture-raised goats.",
    seasonality: ["Year-round"],
    nutritionScore: 78,
  },
  {
    ...
    farmId: 4,
    image:
      "https://images.unsplash.com/photo-1563746924237-f81951d2cdf8?w=250&h=250&fit=crop",
    fallbackImage:
      "https://images.unsplash.com/photo-1599421498111-ad70bebb8404?w=250&h=250&fit=crop",
  ...
  },
  {
    ...
    farmId: 5,
    image:
      "https://images.unsplash.com/photo-1535915087683-3bed29b9afb0?w=250&h=250&fit=crop",
    fallbackImage:
      "https://images.unsplash.com/photo-1556801712-76c8eb07bbc9?w=250&h=250&fit=crop",
...
const WeatherDisplay: React.FC<{ farmLocation: LatLngTuple }> = ({
  farmLocation,
}) => {
...
const SeasonalForecast: React.FC<{ ingredients: Ingredient[] }> = ({
  ingredients,
}) => {
  ...
  const inSeasonIngredients = ingredients.filter(
    (ing) =>
      ing.seasonality.includes(currentSeason) ||
      ing.seasonality.includes("Year-round")
  );

  const upcomingIngredients = ingredients.filter(
    (ing) =>
      ing.seasonality.includes(nextSeason) &&
      !ing.seasonality.includes(currentSeason) &&
      !ing.seasonality.includes("Year-round")
  );
  ...
  return (
    <div className="border border-primary-light p-3 rounded-lg mt-4 bg-primary-light bg-opacity-5">
      <h5 className="font-semibold text-primary-dark text-sm mb-2">
        ...
        <div className="flex flex-wrap gap-1 mt-1">
          {inSeasonIngredients.length > 0 ? (
            ...
            <span className="text-xs text-neutral-dark italic">
              Limited seasonal items available
            </span>
          )}
        </div>
      </div>
...
const SustainabilityCalculator: React.FC<{ farm: Farm }> = ({ farm }) => {
  ...
  return (
    <div className="mt-4 p-3 bg-emerald-50 rounded-lg border border-emerald-200">
      <h5 className="font-semibold text-emerald-700 text-sm mb-2">
      ...
      <div className="mt-3 text-center">
        <span className="text-xs text-emerald-600">
          By choosing ingredients from {farm.name}, each dish saves
          approximately {(milesAvoided * 0.01 + carbonSavings * 0.1).toFixed(1)}{" "}
...
const CookingTutorialPreview: React.FC<{ ingredient: Ingredient }> = ({
  ingredient,
}) => {
  ...
  return (
    <div className="mt-4 p-3 bg-primary-light bg-opacity-5 rounded-lg border border-primary border-opacity-20">
      <div className="flex justify-between items-center mb-2">
        <h5 className="font-semibold text-primary-dark text-sm">
          Cooking Tutorial
        </h5>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-primary font-heading text-4xl md:text-5xl font-bold mb-4">
            Our Ingredient Sourcing Map
          </h2>
          <div className="w-24 h-1 bg-accent mx-auto mb-6"></div>
          <p className="text-neutral-dark max-w-2xl mx-auto">
            Discover where every ingredient in our dishes comes from - all
            sourced within 50 miles of our kitchen
          </p>
        </motion.div>
                    ...
                    <Popup>
                      <div className="text-center">
                        <h3 className="font-bold text-primary">
                          VivaVeggie Restaurant
                        </h3>
                        <p className="text-sm">
                          Our farm-to-table kitchen in Charlotte
                        </p>
                      </div>
                    </Popup>
                  </Marker>
            ...
            {selectedFarm ? (
              <div>
                ...
                >
                  <div className="flex justify-between items-start">
                    <h3 className="font-heading text-xl text-primary-dark">
                      {selectedFarm.name}
                    </h3>
                  ...
                  <div className="flex items-center mt-2 mb-4">
                    ...
                    <span className="ml-2 text-sm text-primary font-bold">
                      {selectedFarm.sustainabilityScore}
                    </span>
                  ...
                  <h4 className="font-heading text-lg text-primary-dark mt-6 mb-3">
                    Sourced Ingredients
                  </h4>
                  <div className="grid grid-cols-1 gap-4">
                    <AnimatePresence>
                      {getIngredientsForFarm(selectedFarm.id).map(
                        (ingredient) => (
                          <motion.div
                            key={ingredient.id}
                            className={`p-3 rounded-lg cursor-pointer transition-all duration-300 ${
                              selectedIngredient?.id === ingredient.id
                                ? "bg-primary bg-opacity-10 shadow-md"
                            ...
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                ...
                                <div className="flex items-center mt-1">
                                  <span className="text-xs text-primary-dark mr-1">
                                    Nutrition Score:
                                  </span>
              ...
              <div className="h-full flex flex-col items-center justify-center text-center">
                ...
                <p className="text-neutral-dark mb-4">
                  Click on any farm marker on the map to learn more about our
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full mt-4">
                    ...
                    <ul className="space-y-2 text-sm">
                      ...
                      <li className="flex justify-between">
                        ...
                        <span className="font-medium text-primary-dark">
                          {(
                            farms.reduce(
                              (acc, farm) => acc + farm.sustainabilityScore,
                              0
                            ) / farms.length
                          ).toFixed(0)}
                          /100
                  ...
                  <div className="bg-secondary bg-opacity-5 p-4 rounded-lg">
                    <h4 className="font-semibold text-secondary-dark text-sm mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 border border-primary border-opacity-20 rounded-lg bg-primary bg-opacity-5">
              ...
              <p className="text-neutral-dark text-sm">
                We source 90% of our ingredients from within 50 miles of our
                restaurant, reducing food miles and supporting our local farming
                community.
              </p>
            </div>
            ...
            <div className="p-4 border border-primary border-opacity-20 rounded-lg bg-primary bg-opacity-5">
              ...
              <p className="text-neutral-dark text-sm">
                We partner exclusively with farms using regenerative agriculture
                practices, organic methods, and responsible resource management.
              </p>
            </div>
            ...
            <div className="p-4 border border-primary border-opacity-20 rounded-lg bg-primary bg-opacity-5">
              ...
              <p className="text-neutral-dark text-sm">
                We provide full visibility into our supply chain, including farm
                practices, harvest dates, and transportation methods for each
                ingredient we use.
              </p>
            </div>
          </div>
