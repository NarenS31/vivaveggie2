...
const tourPoints: TourPoint[] = [
  {
    ...
    image: diningRoomSvg,
    description:
      "Our bright and airy dining room features natural materials and green accents, reflecting our commitment to sustainability. Each table is adorned with fresh herbs from our garden.",
    ...
    hotspots: [
      {
        ...
        description:
          "Our tables are crafted from reclaimed oak barrels from local wineries. Each one tells a story of local craftsmanship and sustainability.",
      },
      {
        id: "plants",
        x: 15,
        ...
        title: "Living Plants",
        description:
          "We incorporate living plants throughout our dining space to improve air quality and create a connection to nature while dining.",
      },
      {
        id: "lighting",
        x: 40,
        ...
        description:
          "Our pendant lights use 75% less energy than traditional restaurant lighting and are designed to mimic the color spectrum of natural sunlight.",
      },
      {
        id: "art",
        x: 75,
        ...
        title: "Local Artwork",
        description:
          "Our walls feature rotating exhibitions from local artists, celebrating our community's creativity.",
      },
      {
        id: "acoustics",
        x: 85,
        ...
        title: "Sound Design",
        description:
          "Special acoustic panels and living walls help create the perfect ambiance while maintaining comfortable sound levels.",
      },
      {
        id: "windows",
        x: 25,
        ...
        title: "Smart Windows",
        description:
          "Our electrochromic windows automatically adjust tint based on sunlight, reducing energy usage while maintaining perfect lighting.",
      },
    ],
    achievements: [
      {
        ...
        description:
          "You explored the dining room and discovered our commitment to sustainable furnishings.",
        icon: "🪑",
        unlocked: false,
      },
    ],
  },
  {
    ...
    image: kitchenSvg,
    description:
      "Our open kitchen concept allows you to see our chefs in action, preparing farm-fresh ingredients with care and creativity.",
    ...
    hotspots: [
      {
        ...
        description:
          "Watch our head chef transform freshly harvested ingredients into culinary masterpieces right before your eyes.",
      },
      {
        id: "herb-wall",
        x: 70,
        ...
        description:
          "Our indoor herb wall allows chefs to snip fresh herbs moments before they're added to your dish, ensuring maximum flavor and nutrition.",
      },
      {
        id: "zero-waste",
        x: 20,
        ...
        description:
          "Our kitchen implements a comprehensive zero-waste system, where trim and scraps are repurposed into stock, sauces, or returned to our compost system.",
      },
    ],
    achievements: [
      {
        ...
        description:
          "You witnessed our sustainable kitchen practices and farm-to-table preparation methods.",
        icon: "👨‍🍳",
        unlocked: false,
      },
    ],
  },
  {
    ...
    image: gardenSvg,
    description:
      "Our on-site vegetable garden supplies many of the fresh ingredients used in our kitchen daily, reducing food miles to mere steps.",
    ...
    hotspots: [
      {
        ...
        description:
          "Our raised beds use companion planting techniques to naturally deter pests and enhance growth without chemicals.",
      },
      {
        id: "compost",
        x: 75,
        ...
        description:
          "Food scraps from the kitchen are transformed into nutrient-rich compost here, completing our sustainability cycle.",
      },
      {
        id: "rainwater",
        x: 20,
        ...
        description:
          "This advanced rainwater harvesting system collects water from our roof for garden irrigation, reducing our water footprint.",
      },
    ],
    achievements: [
      {
        ...
        description:
          "You explored our organic garden and learned about our sustainable growing practices.",
        icon: "🌱",
        unlocked: false,
      },
    ],
    ...
    if (point) {
      ...
      if (!visitedPoints.includes(pointId)) {
        ...
        if (point.achievements) {
          const newAchievements = point.achievements
            .filter((a) => !userAchievements.includes(a.id))
            .map((a) => a.id);

          if (newAchievements.length > 0) {
            const achievement = point.achievements.find(
      ...
      if (allVisited && !tourCompleted) {
        ...
        setTimeout(() => {
          setPopupMessage(
            "🏆 Congratulations! You've completed the full restaurant tour!"
          );
          setShowPopup(true);
        }, 1000);
      }
      ...
      <div className="container mx-auto px-4 py-12 bg-gradient-to-b from-primary-dark/10 to-transparent">
        ...
        >
          ...
          <p className="text-neutral-dark max-w-2xl mx-auto">
            Explore our restaurant virtually and discover the sustainable
            practices behind our farm-to-table philosophy
          </p>
        </motion.div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg order-2 lg:order-1">
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-wrap gap-2">
                {tourPoints
                  .flatMap((point) => point.achievements || [])
                  .map((achievement) => (
                    <div
                      key={achievement.id}
            ...
            <div className="bg-white p-4 rounded-lg shadow-lg">
              ...
              <div className="flex justify-between">
                <div className="text-neutral-dark text-sm">
                  ...
                  {
                    currentPoint.factoids[
                      Math.floor(Math.random() * currentPoint.factoids.length)
                    ]
                  }
                </div>
