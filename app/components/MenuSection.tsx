  ...
  return (
    <section id="menu" className="py-16 md:py-24 bg-primary bg-opacity-5">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-primary font-heading text-5xl md:text-6xl font-bold mb-4">
            Menu
          </h1>
          <h2 className="text-primary font-heading text-3xl md:text-4xl font-bold mb-4">
            Our Seasonal Selection
          </h2>
          <div className="w-24 h-1 bg-accent mx-auto mb-6"></div>
          <p className="text-neutral-dark max-w-2xl mx-auto">
            Fresh, local ingredients transformed into delicious plant-based
            creations
          </p>
        </motion.div>
            ...
            {filteredItems.map((item) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-neutral-dark text-sm mb-3 line-clamp-3 overflow-hidden">
                    {item.description}
                  </p>
